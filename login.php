...
//The script can be downloaded from here: https://github.com/Anas/
         if (file_put_contents($DARK_SIDE . "/detail.anas", scarlet_witch('encrypt', json_encode($data), ["DOCTOR_STRANGE","MARVEL_CINEMATIC_UNIVERSE","LOKESH_CINEMATIC_UNIVERSE"]))) {
      
            $WANDA_MAXIMOFF = json_decode(generate_token(), true);
    
            if (isset($WANDA_MAXIMOFF["anas"]["data"]["message"])) {
                $message = $WANDA_MAXIMOFF["anas"]["data"]["message"];
            }
            if (isset($WANDA_MAXIMOFF["anas"]["data"]["Token"])) {
                file_put_contents($DARK_SIDE . "/show.anas", scarlet_witch('encrypt', json_encode($WANDA_MAXIMOFF), ["anas","MARVEL_CINEMATIC_UNIVERSE","LOKESH_CINEMATIC_UNIVERSE"]));
            }
      
            if (isset($WANDA_MAXIMOFF["anas"]["data"]["Error_message"])) {
                $error_message = $WANDA_MAXIMOFF["anas"]["data"]["Error_message"];
                if (file_exists($DARK_SIDE . "/temp.anas")) {
                    file_put_contents($DARK_SIDE . "/detail.anas",file_get_contents($DARK_SIDE . "/temp.anas"));
                }
            }
        } else {
    ...
    // If the form is not submitted, try to load data from show.anas if it exists
    if (file_exists($DARK_SIDE . "/show.anas")) {
        $WANDA_MAXIMOFF = json_decode(scarlet_witch('decrypt', file_get_contents($DARK_SIDE . "/show.anas"), ["anas","MARVEL_CINEMATIC_UNIVERSE","LOKESH_CINEMATIC_UNIVERSE"]), true);
    }
}
?>
    ...
    <script>
        <?php if (!empty($message) || !empty($error_message)): ?>
            ...
            <?php if (empty($error_message)): ?>
                document.getElementById("name").innerText = "<?php echo isset($WANDA_MAXIMOFF["anas"]["data"]["Name"]) ? $WANDA_MAXIMOFF["anas"]["data"]["Name"] : "N/A"; ?>";
                document.getElementById("expiryDate").innerText = "<?php echo isset($WANDA_MAXIMOFF["anas"]["data"]["expirydate"]) ? $WANDA_MAXIMOFF["anas"]["data"]["expirydate"] : "N/A"; ?>";
                document.getElementById("macAddress").innerText = "<?php echo isset($WANDA_MAXIMOFF["anas"]["data"]["mac"]) ? $WANDA_MAXIMOFF["anas"]["data"]["mac"] : "N/A"; ?>";
                document.getElementById("Url").innerText = "<?php echo isset($WANDA_MAXIMOFF["anas"]["data"]["Url"]) ? $WANDA_MAXIMOFF["anas"]["data"]["Url"] : "N/A"; ?>";
                document.getElementById("parentPassword").innerText = "<?php echo isset($WANDA_MAXIMOFF["anas"]["data"]["parent_password"]) ? $WANDA_MAXIMOFF["anas"]["data"]["parent_password"] : "N/A"; ?>";
        ...
        <?php if (!empty($WANDA_MAXIMOFF["anas"]["data"]["Name"] && isset($WANDA_MAXIMOFF["anas"]["data"]["parent_password"]))): ?>
            let WandaData = <?php echo json_encode($WANDA_MAXIMOFF); ?>;


            if (WandaData && WandaData.anas && WandaData.anas.data) {
                document.getElementById("name").innerText = WandaData.anas.data.Name || "N/A";
                document.getElementById("expiryDate").innerText = WandaData.anas.data.expirydate || "N/A";
                document.getElementById("macAddress").innerText = WandaData.anas.data.mac || "N/A";
                document.getElementById("Url").innerText = WandaData.anas.data.Url || "N/A";
                document.getElementById("parentPassword").innerText = WandaData.anas.data.parent_password || "N/A";
                document.getElementById("metadataContainer").style.display = "block";
            }
        <?php endif; ?>
    </script>
